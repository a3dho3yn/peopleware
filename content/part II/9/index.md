...
{{< figure src="9-1.webp" title="شکل ۱-۹ گستره‌ی فضای اختصاص داده شده" alt="شکل ۱-۹ گستره‌ی فضای اختصاص داده شده">}}
</div>
...
<div class="text-center">
{{< figure src="9-2.webp" title="شکل ۲-۹ اثر دیمارکو-لیستر" alt="شکل ۲-۹ اثر دیمارکو-لیستر">}}
</div>
