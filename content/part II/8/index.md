...
weight: 12
description: 'افراد ممکن است برای بهره‌وری بیش‌تر زودتر بیایند، دیرتر بروند و یا سعی کنند جیم شوند و یک روز در خانه بمانند تا بتوانند قسمت مهمی از کار را به انجام برسانند.'
tags:
    - ساعت کاری
    - عدم تمرکز
    - اضافه کاری
...
*«این دفتر تمام روز یک باغ وحش است! امّا حدود ساعت ۶ بعدازظهر، همه چیز آرام شده و واقعاً می‌توانید کاری را به نتیجه برسانید.»*
...
{{< figure src="8-1.webp" title="شکل ۱-۸ تنوع بهره‌وری بین افراد" alt="شکل ۱-۸ تنوع بهره‌وری بین افراد">}}
</div>
...
<div class="text-center">
{{< figure src="8-2.webp" title="شکل ۲-۸ اختلاف اشخاص در عملکرد" alt="شکل ۲-۸ اختلاف اشخاص در عملکرد">}}
</div>
